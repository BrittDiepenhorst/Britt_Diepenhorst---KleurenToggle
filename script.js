...
const makeGrey = () => {
    ...
    body.classList.remove("color-orange");
    body.classList.remove("color-purple");
...
const makeRed = () => {
    ...
    body.classList.remove("color-home");
    body.classList.remove("color-orange");
    body.classList.remove("color-purple");
    body.classList.remove("color-green");
...
buttonToggleNav.addEventListener("mouseout", toggleNav);
